...
public class BookShop {
    ...
    public static void main(String[] args) {
        Book book1 = new Book("Rawling", "Harry Potter. Philosopher's Stone", 20, true, 15.0);
        Book book2 = new Book("Rawling", "Harry Potter. Chamber of Secrets", 10, true, 10.0);
        Book book3 = new Book("Rawling", "Harry Potter. Prisoner of Azkaban", 10, true, 10.0);
        Book book4 = new Book("M. Twain", "Tom Sawyer", 10, true, 10.0);
        Book book5 = new Book("L. Tolstoy", "War and Pease", 10, true, 10.0);
        ...
        Book book9 = new Book("Rawling", "Harry Potter. Goblet of Fire", 10, true, 10.0);
        Book book10 = new Book("Rawling", "Harry Potter. Order of the Phoenix", 10, true, 10.0);
        ...
        Collections.sort(books, new Comparator<Book>() { // anonymous comparator
            @Override
